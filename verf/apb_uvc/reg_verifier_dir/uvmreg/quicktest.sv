...
// User register sequence
	...
	class qt_test extends uvm_test;
		elastic_buffer_apb_regs_vendor_mohamed_tarek_library_flat_version_1_0 model;
		...
		virtual function void build();
			...
			model=elastic_buffer_apb_regs_vendor_mohamed_tarek_library_flat_version_1_0::type_id::create("model", this);
			model.build();
			model.set_hdl_path_root("elastic_buffer_apb_regs");
			model.apb_map.set_auto_predict(1);
			model.apb_map.set_sequencer(hi_uvc0.sqr,adapter);
			model.lock_model();
